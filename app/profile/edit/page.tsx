  ...
  return (
    <main className="flex min-h-[calc(100vh-64px)] items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md bg-white p-10 rounded-3xl shadow-xl border border-jade-200/60">
        <Link
          href="/profile"
          className="inline-block text-sm font-semibold text-gray-400 hover:text-jade-600 transition-colors mb-4"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1.5">
              Chữ thường, số, dấu gạch dưới, 3-20 ký tự. Dùng để tạo link trang
              cá nhân công khai.
            </p>
          </div>
